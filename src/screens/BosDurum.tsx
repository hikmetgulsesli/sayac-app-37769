...
export function BosDurum(props: BosDurumProps) {
  return (
    <>
      {/*  SideNavBar (Mobile hidden)  */}
      <nav className="hidden lg:flex flex-col w-64 h-screen fixed left-0 top-0 py-8 bg-[#0b1326] border-r border-[#3c4a42]/15">
      <div className="px-8 mb-12">
      <h1 className="text-2xl font-black text-[#4edea3] font-headline tracking-tighter">Kinetik</h1>
      <p className="font-['Space_Grotesk'] tracking-widest uppercase text-[10px] text-[#bbcabf] mt-1">Precision Instrument</p>
      </div>
      <div className="flex-1 space-y-2">
      <a className="flex items-center gap-4 py-3 text-[#4edea3] border-r-2 border-[#4edea3] pl-8 transition-all duration-200 font-headline font-medium" href="#">
      <span className="material-symbols-outlined" style={{fontVariationSettings: "'FILL' 1"}}>numbers</span>
      <span className="font-['Space_Grotesk'] tracking-widest uppercase text-[10px]">Counter</span>
      </a>
      <a className="flex items-center gap-4 py-3 text-[#bbcabf] pl-8 hover:bg-[#131b2e] hover:text-white transition-colors group" href="#">
      ...
      <header className="w-full top-0 sticky z-50 lg:hidden bg-[#0b1326]">
      <div className="flex justify-between items-center px-6 py-4 w-full bg-[#131b2e]">
      <div className="text-xl font-bold tracking-tighter text-[#4edea3] font-headline uppercase">Kinetik Sayaç</div>
      <div className="flex gap-4">
      <button className="text-[#bbcabf] hover:scale-105 active:scale-95 transition-all">
      <span className="material-symbols-outlined">history</span>
      </button>
      <button className="text-[#bbcabf] hover:scale-105 active:scale-95 transition-all">
      <span className="material-symbols-outlined">settings</span>
      ...
      {/*  Main Content Canvas  */}
      <main className="lg:ml-64 p-6 md:p-12 min-h-screen flex flex-col">
      ...
      <span className="text-on-surface font-label tracking-widest text-[0.6875rem] uppercase font-medium">Hareketsiz</span>
      </div>
      </div>
      <div className="flex flex-col items-center text-center">
      <div className="text-[10rem] md:text-[14rem] font-headline font-black text-on-surface tracking-tighter leading-none mb-4 select-none opacity-90">
                                  0
                              </div>
      ...
      <button className="order-2 md:order-1 text-tertiary font-label tracking-widest uppercase text-[0.75rem] hover:underline decoration-tertiary/50 underline-offset-8 transition-all active:scale-95">
                                  Sıfırla
                              </button>
      <div className="order-1 md:order-2 flex items-center gap-4">
      <button className="w-20 h-20 rounded-full flex items-center justify-center bg-secondary-container/20 text-secondary border border-secondary/10 hover:scale-105 active:scale-95 transition-all duration-200">
      <span className="material-symbols-outlined text-3xl">remove</span>
      </button>
      <button className="h-24 px-12 rounded-[1.5rem] emerald-gradient text-on-primary font-headline font-bold tracking-widest uppercase flex items-center gap-4 primary-glow hover:scale-105 active:scale-95 transition-all duration-200 group">
      ...
      <span className="text-3xl font-headline font-bold">-%</span>
      <span className="text-on-surface-variant text-[0.6875rem] mb-1 uppercase tracking-widest">Değişim</span>
      </div>
      <div className="w-full h-1 bg-surface-container-high rounded-full overflow-hidden">
      <div className="h-full bg-outline-variant w-1/12"></div>
      </div>
      <p className="mt-4 text-[0.6875rem] font-body text-on-surface-variant">Henüz istatistik verisi toplanmadı.</p>
      </div>
      </div>
      </div>
      </main>
      ...
      <div className="bg-[#0b1326] px-6 py-4 flex justify-between items-center bg-[#131b2e]">
      <a className="flex flex-col items-center gap-1 text-[#4edea3]" href="#">
      <span className="material-symbols-outlined" style={{fontVariationSettings: "'FILL' 1"}}>numbers</span>
      <span className="font-['Space_Grotesk'] tracking-widest uppercase text-[8px] font-bold">Counter</span>
      </a>
      <a className="flex flex-col items-center gap-1 text-[#bbcabf]" href="#">
      <span className="material-symbols-outlined">history</span>
      <span className="font-['Space_Grotesk'] tracking-widest uppercase text-[8px] font-bold">History</span>
      </a>
      <a className="flex flex-col items-center gap-1 text-[#bbcabf]" href="#">
      <span className="material-symbols-outlined">monitoring</span>
      <span className="font-['Space_Grotesk'] tracking-widest uppercase text-[8px] font-bold">Analytics</span>
      </a>
      <a className="flex flex-col items-center gap-1 text-[#bbcabf]" href="#">
      <span className="material-symbols-outlined">settings</span>
      <span className="font-['Space_Grotesk'] tracking-widest uppercase text-[8px] font-bold">Settings</span>
      </a>
      </div>
      </div>
    </>
